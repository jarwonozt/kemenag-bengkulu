<x-master-layout>
    @section('title')
        @lang('admin.create_post')
    @endsection
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y"><h5 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Dashboard / <a href="{{ route('posts.index') }}">@lang('admin.post')</a> /</span> @lang('admin.create_post')</h6>
            ...
            <div class="row justify-content-start">
                <div class="col-12 col-md-8 col-xl-8">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="mb-3">
                                <label class="form-label text-primary fw-bold" for="basic-default">@lang('admin.form.publish_date')</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="prefix" name="prefix" type="prefix" class="form-control" placeholder="prefix @lang('admin.post')" value="{{ old('prefix') }}" />
                            ...
                            <div class="mb-3">
                                ...
                                <input id="title" name="title" type="text" class="form-control" placeholder="@lang('admin.form.title') @lang('admin.post')" value="{{ old('title') }}" required/>
    ...
    @push('styles')
        ...
        {{-- <link rel="stylesheet" type="text/css" href="{{asset('app-assets-old/vendors/css/pickers/flatpickr/flatpickr.min.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('app-assets-old/css/plugins/forms/pickers/form-flat-pickr.css')}}"> --}}
    @endpush

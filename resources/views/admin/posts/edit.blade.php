<x-master-layout>
    @section('title')
    @lang('admin.edit_post')
    @endsection
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h5 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Dashboard / <a href="{{ route('posts.index') }}">@lang('admin.post')</a> /</span> @lang('admin.create_post')</h5>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="prefix" name="prefix" type="prefix" class="form-control"
                                            placeholder="prefix @lang('admin.post')" value="{{ $data->prefix }}" />
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="title" name="title" type="text" class="form-control"
                                            placeholder="@lang('admin.form.title') @lang('admin.post')"
                        ...
                        <div class="col-12 col-md-4 col-xl-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3 mt-2">
                                        <label class="form-label text-primary fw-bold text-uppercase"
                                            for="basic-default">tags</label></span>
                                    ...
                                    <div class="mb-3 mt-2">
                                        ...
                                        <div class="d-flex flex-row">
                                            <div class="custom-control custom-radio">
                                                <input name="type" type="radio" id="customRadio2"
                                                    class="form-check-input" value="1" {{ $data->type == 1 ? 'checked' : '' }} />
                                                <label class="custom-control-label" for="customRadio2">NORMAL</label>
                                            </div>
                                            <div class="custom-control custom-radio ms-2">
                                                <input name="type" type="radio" id="customRadio3"
                                                    class="form-check-input" value="2" {{ $data->type == 2 ? 'checked' : '' }}/>
                                                <label class="custom-control-label"
                                                    for="customRadio3">SLIDE/HEADLINE</label>
                                            </div>
                                        </div>
                                        @if ($errors->has('type'))<span
                                            class="text-danger">{{$errors->first('type')}}</span>@endif
                                    </div>
                                    <div class="mb-3 mt-2">
                                        <label class="form-label text-primary fw-bold text-uppercase"

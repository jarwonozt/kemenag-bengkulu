<x-master-layout>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h5 class="fw-bold py-3 mb-1"><span class="text-muted fw-light">Dashboard /</span> Berita</h5>
            <div class="row mb-2">
                <div class="col">
                    <a href="{{ route('posts.create') }}" class="btn btn-primary">@lang('admin.create_post')</a>
                </div>
            </div>
